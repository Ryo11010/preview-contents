...
export const demoImages = {
  shiftScanner: withBasePath('images/projects/shift-scanner/ICON-base_ShiftScanner_light.png'),
  remoVision: withBasePath('images/projects/removision/ICON-base_RemoVision_light.png'),
  codeClipper: withBasePath('images/projects/codeclipper/ICON-base_CodeClipper_light.png'),
  mhLab: withBasePath('images/projects/mhlab/ICON-base_MHLab_light.png'),
  dialectMuseum: withBasePath('images/projects/dialect-museum/dialectmuseum-screenshot-01-home.webp'),
  corporate: withBasePath('images/projects/dialect-museum/screenshot.webp'),
  videoPlaceholder: withBasePath('images/projects/dialect-museum/dialectmuseum-screenshot-02-download.webp'),
};
...
export const projects: Project[] = [
  {
    ...
    icon: Scan,
    appIcon: demoImages.shiftScanner,
    gallery: [],
    galleryDir: 'projects/shift-scanner',
  ...
  },
  {
    ...
    icon: ShieldCheck,
    appIcon: demoImages.remoVision,
    gallery: [],
    galleryDir: 'projects/removision',
  ...
  },
  {
    ...
    icon: Scissors,
    appIcon: demoImages.codeClipper,
    gallery: [],
    galleryDir: 'projects/codeclipper',
  ...
  },
  {
    ...
    icon: Gamepad2,
    appIcon: demoImages.mhLab,
    gallery: [],
    galleryDir: 'projects/mhlab',
  ...
  },
  {
    ...
    tagline: 'プロダクト群と開発スタイルを遊び心でまとめた公式ポートフォリオ',
    description: '本サイト。モーション豊かなフォルダUIと詳細シートで作品・技術スタック・導線を一元表示。',
    longDescription:
      'Work アーカイブで自社/受託/公式サイトを分類し、Dock ナビとスクラブで高速に横断。詳細シートではギャラリー・機能・技術背景・CTA をまとめ、モバイルでも読みやすいレイアウトとしました。',
    features: [
      'フォルダ型の Work UI でカテゴリ別にプロダクトを整理',
      'Dock ナビ + スクロールロックでセクション間を滑らかに移動',
      '詳細シートにギャラリー/技術背景/CTA を集約',
      'ローカル画像ディレクトリ差し替えでギャラリー更新を即時反映',
    ],
    challenges:
      '重めのモーションを保ちながらスクロール/ナビの決定性とパフォーマンスを維持するため、state 更新を最小化し、フェッチ失敗時は静的データへフォールバックする設計にした。',
    techStack: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Next Image'],
    color: 'from-indigo-400 via-purple-500 to-pink-500',
    accent: 'text-indigo-700 bg-indigo-50',
    icon: Globe,
    gallery: [],
    galleryDir: 'projects/portfolio-site',
    webUrl: withBasePath('/'),
  },
  {
    id: 'funteru-site',
    ...
    icon: Globe,
    gallery: [],
    galleryDir: 'projects/funteru-site',
  ...
  },
  {
    ...
    icon: Library,
    gallery: [],
    galleryDir: 'projects/dialect-museum',
  },
];
...
export const categories: CategoryConfig[] = [
  { id: 'app', label: 'Product Lab', subLabel: 'In-house Apps', icon: Smartphone },
  { id: 'web', label: 'Official Site', subLabel: 'Corporate', icon: Globe },
  { id: 'client', label: 'Client Works', subLabel: 'Contract', icon: Briefcase },
];
